...
Arq bundles the following third-party material. Each item keeps its own licence;
nothing here is covered by Arq's own Apache-2.0 licence.

## Excalifont (embedded font)

`packages/render/fonts/Excalifont-Regular.woff2` is the Latin subset of Excalifont,
the hand-drawn typeface used by Excalidraw. It is embedded into exported SVGs so a
diagram renders identically on a machine that does not have the font installed.

    Copyright (c) 2024 by Excalidraw. All rights reserved.
    Manufacturer/designer: Your Own Font Foundry (Virgil);
                           Jan Filipek / DizajnDesign (Excalifont, modifications)
                           https://dizajndesign.sk

Licensed under the SIL Open Font License, Version 1.1, reproduced below.

"Excalifont" is a trademark of Excalidraw. Arq bundles the font unmodified and is
neither affiliated with nor endorsed by Excalidraw.
